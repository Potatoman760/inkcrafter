  ...
  "npcs": [
    {
      ...
      "statuses": [{ "key": "standing", "label": "Standing", "initial": "stranger",
                     "values": ["stranger", "ally", "sworn"] }],
      "flags":    [{ "key": "knows", "label": "Knows", "initial": false }]
    }
  ]
}`
